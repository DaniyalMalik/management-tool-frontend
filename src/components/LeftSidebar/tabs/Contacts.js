...
const ContactsTab = ({ data, onChange }) => {
  ...
  return (
    <>
      ...
      {data.jsonld['@graph'][1].contactPoint &&
        data.jsonld['@graph'][1].contactPoint
  ...
  return (
    <div>
      <TextField
        ...
        value={item.phoneNumber ? item.phoneNumber : user.phoneNumber}
      ...
      <TextField
        ...
        placeholder="development@bizstruct.com"
        value={item.email ? item.email : user.email}
