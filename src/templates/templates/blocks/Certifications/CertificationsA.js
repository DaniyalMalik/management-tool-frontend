...
import { formatDate, safetyCheck } from '../../../components/Utilities'
import {} from '../../../templates/blocks/Heading/HeadingA'
...
const CertificationsA = () => {
  ...
  return data.certifications && data.certifications.enable ? (
    <div>
        ...
        {_.get(data, "jsonld['@graph'][1].hasCredential", [])
          .filter(
            (x) =>
              ...
              _.toLower(_.get(x, 'credentialCategory', '')) !== 'degree',
          )
          .map((x) => (
            <CertificationItem
