...
import { saveAsPdf, saveAsMultiPagePdf } from '../components/Utilities'
...
const PrintDialog = () => {
  ...
  const printTypes = [
    {
      key: 'unconstrained',
      value: `${t('printDialog.printType.types.unconstrained')}`,
    },
    { key: 'fitInA4', value: `${t('printDialog.printType.types.fitInA4')}` },
    {
      key: 'multiPageA4',
      value: `${t('printDialog.printType.types.multiPageA4')}`,
    },
  ]
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h6 className="mt-4 mb-2 text-sm font-medium">
